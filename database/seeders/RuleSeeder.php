    ...
    public function run(): void
    {
        $rules = [
            ...
            [
                ...
                'condition_summary' => 'HAZ <= -2.00 SD dan > -3.00 SD.',
                ...
                'explanation' => 'Rule Decision Tree hasil training menandai anak sebagai stunted ketika HAZ kurang dari atau sama dengan -2.00 SD.',
                'severity' => 'high',
                'source_reference' => 'Extracted Decision Tree rule ml_pipeline/artifacts/extracted_rules.txt; WHO Child Growth Standards: height-for-age z-score.',
            ],
            [
                'code' => 'R6',
                ...
                'condition_summary' => 'HAZ <= -3.00 SD.',
                'recommendation' => 'Sarankan evaluasi segera oleh tenaga kesehatan dan pemantauan pertumbuhan intensif.',
                'explanation' => 'Nilai HAZ kurang dari atau sama dengan -3.00 SD menunjukkan defisit pertumbuhan linear yang berat.',
                'severity' => 'urgent',
